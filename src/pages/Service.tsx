...
const services = [
  {
    ...
    description: '최적화된 AI VFX를 제공할 수 있는 효율적이고 높은 퀄리티의 AI 파이프라인을 구축해 BtoB 서비스를 제공',
  ...
  },
  {
    ...
    subtitle: 'AI Storytelling & Production',
  ...
  },
  {
    ...
    subtitle: 'AI Contents Technology',
    description: '차세대 콘텐츠 제작을 위한 AI 기술 연구개발 및 솔루션 구축',
    images: [aiTech1, aiTech2],
    features: ['AI Research', 'Technology Solutions', 'Content Pipeline'],
