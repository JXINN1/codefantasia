...
export default function About() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#e8e9ed] via-[#edeef2] to-[#f0f1f4] overflow-hidden">
      <Helmet>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <AnimatedSection animation="fade-up">
            ...
            <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold max-w-4xl">
              <span className="bg-gradient-to-r from-violet-600 via-fuchsia-500 to-cyan-500 bg-clip-text text-transparent">About Us</span>
            </h1>
          </AnimatedSection>
        </div>
      </section>
